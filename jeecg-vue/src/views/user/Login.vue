<template>
    <div class="main">
        <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
            <a-form-item>
                <a-input size="large" v-decorator="['username', validatorRules.username, { validator: handleUsernameOrEmail }]" type="text" placeholder="帐号">
            ...
            <a-form-item style="margin-top:24px">
                <a-button size="large" type="primary" htmlType="submit" class="login-button" :loading="loginBtn" @click.stop.prevent="handleSubmit" :disabled="loginBtn"
                    >确定
                </a-button>
            </a-form-item>
...
export default {
    ...
    data() {
        return {
            customActiveKey: "loginByAccount",
            loginBtn: false,
    ...
    methods: {
        ...
        handleSubmit() {
            ...
            that.loginBtn = true;
            // 使用账户密码登录
            if (that.customActiveKey === "loginByAccount") {
