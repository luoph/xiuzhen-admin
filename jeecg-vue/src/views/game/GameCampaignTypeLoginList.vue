<template>
    <a-card :bordered="false">
            ...
            <a-form layout="inline" @keyup.enter.native="searchQuery">
                <a-row :gutter="24">
                    ...
                    <template v-if="toggleSearchStatus">
                        <a-col :md="6" :sm="8">
                            <a-form-item label="登录天数">
                                <a-input placeholder="请输入登录天数" v-model="queryParam.loginDay"></a-input>
                            </a-form-item>
                        </a-col>
                    </template>
                    <a-col :md="6" :sm="8">
        ...
        <div class="table-operator">
            ...
            <a-button type="primary" icon="download" @click="handleExportXls('登录活动')">导出</a-button>
        ...
        <gameCampaignTypeLogin-modal ref="modalForm" @ok="modalFormOk"></gameCampaignTypeLogin-modal>
    </a-card>
</template>
