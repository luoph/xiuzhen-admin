<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('节日活动-夺宝战令')">导出</a-button>
    ...
    <game-campaign-type-lottery-token-modal ref="modalForm" @ok="modalFormOk"></game-campaign-type-lottery-token-modal>
  </a-card>
</template>
...
<script>
  ...
  import GameCampaignTypeLotteryTokenModal from './modules/GameCampaignTypeLotteryTokenModal'

  export default {
    name: 'GameCampaignTypeLotteryTokenList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      GameCampaignTypeLotteryTokenModal
    },
    data () {
      return {
        description: '节日活动-夺宝战令管理页面',
        model: {},
        // 表头
        columns: [
          {
        ...
        url: {
          list: "/game/gameCampaignTypeLotteryToken/list",
          delete: "/game/gameCampaignTypeLotteryToken/delete",
          deleteBatch: "/game/gameCampaignTypeLotteryToken/deleteBatch",
          exportXlsUrl: "/game/gameCampaignTypeLotteryToken/exportXls",
    ...
    methods: {
      ...
      handleAdd() {
        ...
        this.$refs.modalForm.title = '新增夺宝战令配置';
      },
      getQueryParams() {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'reward',text:'普通奖励'})
        fieldList.push({type:'string',value:'specialReward',text:'特殊奖励'})
