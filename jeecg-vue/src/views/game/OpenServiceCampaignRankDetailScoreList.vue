<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('开服排行消耗道具分数')">导出</a-button>
    ...
    <open-service-campaign-rank-detail-score-modal ref="modalForm" @ok="modalFormOk"></open-service-campaign-rank-detail-score-modal>
  </a-card>
</template>
  ...
  data() {
    return {
      ...
      url: {
        ...
        importTextUrl: 'game/openServiceCampaignRankDetailScore/importText'
      },
      dictOptions: {}
    };
  },
