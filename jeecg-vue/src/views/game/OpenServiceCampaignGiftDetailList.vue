<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('开服活动礼包配置')">导出</a-button>
    ...
    <open-service-campaign-gift-detail-modal ref="modalForm"
                                             @ok="modalFormOk"></open-service-campaign-gift-detail-modal>
  </a-card>
</template>
  ...
  data() {
    return {
      ...
      url: {
        ...
        importTextUrl: 'game/openServiceCampaignGiftDetail/importText'
      },
      dictOptions: {}
    };
  },
