    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="客户端最小版本号">
          <a-input-number v-decorator="['minVersion', {}]" style="width: 100%" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="客户端最大版本号">
          <a-input-number v-decorator="['maxVersion', {}]" style="width: 100%" />
        </a-form-item>
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.$nextTick(() => {
        ...
        this.form.setFieldsValue({
          stopServerRefundVersionType:
            null != this.model.stopServerRefundVersionType && '' != this.model.stopServerRefundVersionType ? this.model.stopServerRefundVersionType.split(',').sort() : []
        });
      });
    },
    close() {
