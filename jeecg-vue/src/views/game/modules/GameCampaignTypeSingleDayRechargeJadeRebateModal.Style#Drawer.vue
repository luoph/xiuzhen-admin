<template>
  <a-drawer
    ...
    destroyOnClose
    :visible="visible">
    <game-campaign-type-single-day-recharge-jade-rebate-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit" normal></game-campaign-type-single-day-recharge-jade-rebate-form>
