<template>
  <j-modal
    ...
    @cancel="handleCancel"
    cancelText="关闭">
    <game-campaign-type-single-day-recharge-jade-rebate-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"></game-campaign-type-single-day-recharge-jade-rebate-form>
  </j-modal>
</template>
