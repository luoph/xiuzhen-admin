    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="免费抽奖次数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['freeNum', validatorRules.freeNum]" placeholder="请输入免费抽奖次数"
                          style="width: 100%"/>
        </a-form-item>
        <a-form-item label="获奖记录显示数量" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['rewardRecordNum', validatorRules.rewardRecordNum]"
                          placeholder="请输入获奖记录显示数量" style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="展示特奖" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['ssrShowReward', validatorRules.ssrShowReward]"
                   placeholder='请输入展示特奖 e.g. [{"itemId":1001, "num":1}]'></a-input>
        </a-form-item>
        <a-form-item label="展示大奖" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['srShowReward', validatorRules.srShowReward]"
                   placeholder='请输入展示大奖 e.g. [{"itemId":1001, "num":1}]'></a-input>
        </a-form-item>
        <a-form-item label="展示奖励" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['showReward', validatorRules.showReward]"
                   placeholder='请输入展示奖励 e.g. [{"itemId":1001, "num":1}]'></a-input>
        </a-form-item>
        <a-form-item label="重置大奖" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['resetReward', validatorRules.resetReward]"
                   placeholder="请输入重置大奖 e.g. [1002, 1010, 1021, 1031]"></a-input>
        </a-form-item>
        ...
        <a-form-item label="排名奖励邮件标题" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['rankRewardEmailTitle', validatorRules.rankRewardEmailTitle]"
                      placeholder="请输入排名奖励邮件标题"/>
        </a-form-item>
        <a-form-item label="排名奖励邮件内容" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['rankRewardEmailContent', validatorRules.rankRewardEmailContent]"
                      placeholder="请输入排名奖励邮件内容"/>
        </a-form-item>
        <a-form-item label="积分奖励邮件标题" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['scoreRewardEmailTitle', validatorRules.scoreRewardEmailTitle]"
                      placeholder="请输入积分奖励邮件标题"/>
        </a-form-item>
        <a-form-item label="积分奖励邮件内容" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['scoreRewardEmailContent', validatorRules.scoreRewardEmailContent]"
                      placeholder="请输入积分奖励邮件内容"/>
        </a-form-item>
      ...
      <a-tabs v-if="isEdit" defaultActiveKey="1">
        <a-tab-pane tab="奖池配置" forceRender key="1">
          <open-service-campaign-lottery-detail-pool-list
            ref="poolList"></open-service-campaign-lottery-detail-pool-list>
        </a-tab-pane>
        <a-tab-pane tab="积分道具" forceRender key="2">
          <open-service-campaign-lottery-detail-score-list
            ref="scoreList"></open-service-campaign-lottery-detail-score-list>
        </a-tab-pane>
        <a-tab-pane tab="榜单配置" forceRender key="3">
          <open-service-campaign-lottery-detail-ranking-list
            ref="rankingList"></open-service-campaign-lottery-detail-ranking-list>
        </a-tab-pane>
      </a-tabs>
    </a-spin>
  </a-modal>
