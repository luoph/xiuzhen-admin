...
export default {
    ...
    methods: {
        ...
        edit(record) {
            ...
            this.visible = true;
            this.$nextTick(() => {
                this.form.setFieldsValue(pick(this.model, "operation", "forbiddenId", "serverId", "type", "banKey", "banValue", "reason", "isForever", "startTime", "endTime", "createTime", "createBy"));
            });
        },
        close() {
            this.$emit("close");
        ...
        popupCallback(row) {
            this.form.setFieldsValue(pick(row, "operation", "forbiddenId", "serverId", "type", "banKey", "banValue", "reason", "isForever", "startTime", "endTime", "createTime", "createBy"));
        },
    }
};
</script>
