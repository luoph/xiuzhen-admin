    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="详情id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number :disabled="true" v-decorator="['consumeDetailId', validatorRules.consumeDetailId]"
        ...
        <a-form-item label="统计类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select placeholder="请选择统计类型" v-decorator="['consumeType', validatorRules.consumeType]"
                    initialValue="1">
        ...
        <a-form-item label="开始时间(子活动开始第n天)" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['startDay', validatorRules.startDay]"
                          placeholder="请输入开始时间(子活动开始第n天, 0表示子活动开始第1天)" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="开启前是否统计" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select placeholder="开启前是否统计" v-decorator="['statisticsNotStart', validatorRules.statisticsNotStart]"
                    initialValue="1">
        ...
        <a-form-item label="消耗道具" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['consumeItems', validatorRules.consumeItems]"
                   placeholder="请输入消耗道具 e.g. [1001, 1002, 1003]"></a-input>
        </a-form-item>
