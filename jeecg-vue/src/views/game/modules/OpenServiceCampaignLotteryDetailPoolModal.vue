    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="奖池id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['poolId', validatorRules.poolId]" placeholder="请输入奖池id"
                          style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="掉落权重" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['weight', validatorRules.weight]" placeholder="请输入掉落权重"
                          style="width: 100%"/>
        </a-form-item>
