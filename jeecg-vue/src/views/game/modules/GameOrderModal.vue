    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="充值订单号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="isEdit" v-decorator="['orderId', validatorRules.orderId]"
                   placeholder="请输入充值订单号"></a-input>
        </a-form-item>
        <a-form-item label="平台订单号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="isEdit" v-decorator="['queryId', validatorRules.queryId]"
                   placeholder="请输入平台订单号"></a-input>
        </a-form-item>
        ...
        <a-form-item label="商品id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="isEdit" v-decorator="['productId', validatorRules.productId]"
                   placeholder="请输入商品id"></a-input>
        </a-form-item>
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="订单状态">
          <a-select :disabled="isEdit" placeholder="请选择订单状态"
        ...
        <a-form-item label="支付金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number :disabled="isEdit" v-decorator="['payAmount', validatorRules.payAmount]"
                          placeholder="请输入支付金额" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="订单金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number :disabled="isEdit" v-decorator="['orderAmount', validatorRules.orderAmount]"
                          placeholder="请输入订单金额" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="折扣金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number :disabled="isEdit" v-decorator="['discountAmount', validatorRules.discountAmount]"
                          placeholder="请输入折扣金额" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="custom" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number :disabled="isEdit" v-decorator="['custom', validatorRules.custom]"
                          placeholder="请输入透传参数" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="充值货币" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="isEdit" v-decorator="['currency', validatorRules.currency]"
                   placeholder="请输入充值货币"></a-input>
        </a-form-item>
