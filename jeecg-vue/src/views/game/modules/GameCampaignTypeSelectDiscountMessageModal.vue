    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="传闻推送时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['pushTime', validatorRules.pushTime]"
                   placeholder="请输入推送时间 时分秒 12:00:00"></a-input>
        </a-form-item>
        ...
        <a-form-item label="传闻广播次数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['num', validatorRules.num]" placeholder="请输入传闻广播次数"
                          style="width: 100%"/>
        </a-form-item>
