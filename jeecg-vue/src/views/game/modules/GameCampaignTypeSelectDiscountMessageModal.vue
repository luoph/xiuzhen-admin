    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="传闻推送时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['pushTime', validatorRules.pushTime]" placeholder="请输入推送时间 时分秒 12:00:00" />
        </a-form-item>
        <a-form-item label="传闻内容" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['content', validatorRules.content]" placeholder="请输入传闻内容" />
        </a-form-item>
