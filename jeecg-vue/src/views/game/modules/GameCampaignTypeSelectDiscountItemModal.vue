    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="位置序号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['showOrder', validatorRules.showOrder]" placeholder="请输入位置序号"
                          style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="免费领取" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-checkbox v-decorator="['free', {initialValue:false} ]" :checked="form.getFieldValue('free')">
            本组商品是否免费领取
          </a-checkbox>
        </a-form-item>
        ...
        <a-form-item label="免费物品" :labelCol="labelCol" :wrapperCol="wrapperCol"
