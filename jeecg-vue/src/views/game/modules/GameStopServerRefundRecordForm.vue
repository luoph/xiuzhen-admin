  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
           sourceServerId: [
              { required: true, message: '请输入停服的服务器id!'},
           ],
           sourcePlayerId: [
              { required: true, message: '请输入停服的玩家id!'},
           ],
           targetServerId: [
              { required: true, message: '请输入返还的服务器id!'},
           ],
           targetPlayerId: [
              { required: true, message: '请输入返还的玩家id!'},
           ],
           sourceAmount: [
              { required: true, message: '请输入充值总金额!'},
           ],
           targetNum: [
              { required: true, message: '请输入返还总仙玉!'},
           ],
        },
        url: {
