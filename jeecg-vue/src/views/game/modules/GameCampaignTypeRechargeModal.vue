    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="礼包id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['rechargeId', validatorRules.rechargeId]" placeholder="请输入礼包id"
                          style="width: 100%"/>
        </a-form-item>
        <a-form-item label="累计充值额度" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['rechargeAmount', validatorRules.rechargeAmount]"
                          placeholder="请输入累计充值额度" style="width: 100%"/>
        </a-form-item>
