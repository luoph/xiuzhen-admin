    ...
    data () {
      return {
        ...
        validatorRules: {
           ...
           summonConsume: [
              { required: true, message: '请输入抽奖消耗道具!'},
           ],
           changeFavoriteRewardConsume: [
              { required: true, message: '请输入更换心仪大奖消耗!'},
           ],
           summonBigRewardNum: [
              { required: true, message: '请输入第N次开始抽大奖奖池!'},
           ],
           summonFavoriteRewardNum: [
              { required: true, message: '请输入第N次开始抽心仪奖池!'},
           ],
           reward: [
              { required: true, message: '请输入普通奖池!'},
           ],
           bigReward: [
              { required: true, message: '请输入大奖奖池!'},
           ],
           favoriteReward: [
              { required: true, message: '请输入心仪奖池!'},
           ],
           prShow: [
              { required: true, message: '请输入概率公示!'},
           ],
           minLevel: [
