    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-tabs v-if="isEdit" defaultActiveKey="1">
        <a-tab-pane tab="消耗配置" forceRender key="1">
          <open-service-campaign-consume-detail-item-list
            ref="itemList"></open-service-campaign-consume-detail-item-list>
        </a-tab-pane>
        <a-tab-pane tab="传闻配置" forceRender key="2">
          <open-service-campaign-consume-detail-message-list
            ref="messageList"></open-service-campaign-consume-detail-message-list>
        </a-tab-pane>
      </a-tabs>
    </a-spin>
  </a-modal>
