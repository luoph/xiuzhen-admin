        ...
        <a-spin :spinning="confirmLoading">
            <a-form :form="form">
                ...
                <a-form-item label="消耗奖励邮件标题" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input v-decorator="['consumeRewardEmailTitle', validatorRules.consumeRewardEmailTitle]" placeholder="请输入消耗奖励邮件标题"></a-input>
                </a-form-item>
                <a-form-item label="消耗奖励邮件内容" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input v-decorator="['consumeRewardEmailContent', validatorRules.consumeRewardEmailContent]" placeholder="请输入消耗奖励邮件内容"></a-input>
                </a-form-item>
