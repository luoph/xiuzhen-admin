    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="奖励组id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['rewardId', validatorRules.rewardId]" placeholder="请输入奖励组id"
                          style="width: 100%"/>
        </a-form-item>
        <a-form-item label="奖励列表" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['reward', validatorRules.reward]"
                      placeholder='请输入奖励列表 e.g. [{"itemId":1001, "num":1}]'/>
        </a-form-item>
        ...
        <a-form-item label="传闻id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['message', validatorRules.message]" placeholder="请输入传闻id"
                          style="width: 100%"/>
        </a-form-item>
      </a-form>
    </a-spin>
