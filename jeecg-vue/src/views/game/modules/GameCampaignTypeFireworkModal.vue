    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="礼包id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['giftId', validatorRules.giftId]" placeholder="请输入礼包id"
                          style="width: 100%"/>
        </a-form-item>
        <a-form-item label="购买次数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['times', validatorRules.times]" placeholder="请输入购买次数"
                          style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="单次购买数量" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['num', validatorRules.num]" placeholder="请输入单次购买数量"
                          style="width: 100%"/>
        </a-form-item>
