        ...
        <a-spin :spinning="confirmLoading">
            <a-form :form="form">
                ...
                <a-form-item label="充值分类" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input-number v-decorator="['goodsType', validatorRules.goodsType]" placeholder="请输入充值分类" style="width: 100%" />
                </a-form-item>
                <a-form-item label="是否记入累充（0 - 不计入 1 - 记入）" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input-number v-decorator="['amountStat', validatorRules.amountStat]" placeholder="请输入是否记入累充（0 - 不计入 1 - 记入）" style="width: 100%" />
                </a-form-item>
