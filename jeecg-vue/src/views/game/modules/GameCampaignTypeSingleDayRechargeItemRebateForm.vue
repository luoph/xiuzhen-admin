...
export default {
  name: 'GameCampaignTypeSingleDayRechargeItemRebateForm',
  components: {},
  props: {
    // 表单禁用
    disabled: {
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        rechargeAmount: [{ required: true, message: '请输入累充金额!' }],
      ...
      url: {
        add: '/game/gameCampaignTypeSingleDayRechargeItemRebate/add',
        edit: '/game/gameCampaignTypeSingleDayRechargeItemRebate/edit',
        queryById: '/game/gameCampaignTypeSingleDayRechargeItemRebate/queryById'
      }
    };
  },
  computed: {
