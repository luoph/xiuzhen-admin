...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.$nextTick(() => {
        this.form.setFieldsValue(
          pick(this.model, 'campaignId', 'typeId', 'checkpointId', 'monsterId', 'combatPower', 'unlockCheckpointId', 'reward', 'checkpointName', 'minLevel', 'maxLevel')
        );
      });
    },
    close() {
    ...
    popupCallback(row) {
      this.form.setFieldsValue(
        pick(row, 'campaignId', 'typeId', 'checkpointId', 'monsterId', 'combatPower', 'unlockCheckpointId', 'reward', 'checkpointName', 'minLevel', 'maxLevel')
      );
    }
  }
};
