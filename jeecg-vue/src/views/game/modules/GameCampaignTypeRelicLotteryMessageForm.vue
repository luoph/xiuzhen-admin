    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="通关层数推送" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="layer">
              <a-input-number v-model="model.layer" placeholder="请输入通关层数推送" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
export default {
  name: 'GameCampaignTypeRelicLotteryMessageForm',
  components: {},
  props: {
    // 表单禁用
    disabled: {
  ...
  data() {
    return {
      ...
      validatorRules: {
        content: [{ required: true, message: '请输入传闻内容!' }]
      },
      url: {
        add: '/game/gameCampaignTypeRelicLotteryMessage/add',
        edit: '/game/gameCampaignTypeRelicLotteryMessage/edit',
        queryById: '/game/gameCampaignTypeRelicLotteryMessage/queryById'
      }
    };
  },
  computed: {
