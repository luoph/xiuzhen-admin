<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('开服活动排行配置')">导出</a-button>
    ...
    <open-service-campaign-rank-detail-ranking-modal ref="modalForm" @ok="modalFormOk"></open-service-campaign-rank-detail-ranking-modal>
  </a-card>
</template>
  ...
  data() {
    return {
      ...
      url: {
        ...
        importTextUrl: 'game/openServiceCampaignRankDetailRanking/importText'
      },
      dictOptions: {}
    };
  },
