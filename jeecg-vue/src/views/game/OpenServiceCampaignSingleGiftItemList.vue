<template>
  <a-card :bordered="false">
    ...
    <open-service-campaign-single-gift-item-modal ref="modalForm"
                                                  @ok="modalFormOk"></open-service-campaign-single-gift-item-modal>
  </a-card>
</template>
...
export default {
  name: 'OpenServiceCampaignSingleGiftItemList',
  mixins: [JeecgListMixin],
  components: {
    OpenServiceCampaignSingleGiftItemModal
  },
  data() {
    return {
      ...
      url: {
        list: 'game/openServiceCampaignSingleGiftItem/list',
        delete: 'game/openServiceCampaignSingleGiftItem/delete',
        deleteBatch: 'game/openServiceCampaignSingleGiftItem/deleteBatch',
        ...
        importTextUrl: 'game/openServiceCampaignSingleGiftItem/importText'
      },
      dictOptions: {}
    };
  },
