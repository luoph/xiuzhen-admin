            ...
            <a-form layout="inline" @keyup.enter.native="searchQuery">
                <a-row :gutter="24">
                    ...
                    <template v-if="toggleSearchStatus">
                        <a-col :md="6" :sm="8">
                            <a-form-item label="礼包id">
                                <a-input placeholder="请输入礼包id" v-model="queryParam.rechargeId"></a-input>
                            </a-form-item>
                        </a-col>
                        <a-col :md="6" :sm="8">
                            <a-form-item label="累计充值额度">
                                <a-input placeholder="请输入累计充值额度" v-model="queryParam.rechargeAmount"></a-input>
                            </a-form-item>
                        </a-col>
                        <a-col :md="6" :sm="8">
