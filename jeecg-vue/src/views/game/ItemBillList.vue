        ...
        <div class="table-page-search-wrapper">
            <a-form layout="inline" @keyup.enter.native="searchQuery">
                <a-row :gutter="45">
                    ...
                    <a-col :md="5" :sm="5">
                        <a-form-item v-show="queryParam.type === '1'" label="产销点">
                            <a-select-read-json json-file="item_fall_rule" placeholder="产销点"
                                                @onSelectOption="change"></a-select-read-json>
                        </a-form-item>
                        <a-form-item v-show="queryParam.type === '2'" label="产销点">
                            <a-select-read-json json-file="item_expend" placeholder="产销点"
                                                @onSelectOption="change"></a-select-read-json>
                        </a-form-item>
                    </a-col>
