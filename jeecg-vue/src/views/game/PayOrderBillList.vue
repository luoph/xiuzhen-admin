<template>
    <a-card :bordered="false">
        ...
        <div class="table-operator">
            ...
            <a-button type="primary" icon="download" @click="handleExportXls('pay_order')">导出</a-button>
...
import PayOrderBillModal from "./modules/PayOrderBillModal";
    ...
    data() {
        return {
            ...
            url: {
                ...
                delete: "game/payOrderBill/delete",
                deleteBatch: "game/payOrderBill/deleteBatch",
                exportXlsUrl: "game/payOrderBill/exportXls",
                importExcelUrl: "game/payOrderBill/importExcel"
            },
            dictOptions: {
            }
        };
