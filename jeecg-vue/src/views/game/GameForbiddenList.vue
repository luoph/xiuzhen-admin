    ...
    <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
            <a-form layout="inline" @keyup.enter.native="searchQuery">
                ...
                <a-input placeholder="请输入1-登录 2-聊天" v-model="queryParam.type"></a-input>
            </a-form-item>
                </a-col>
                <template v-if="toggleSearchStatus">
                    ...
                    <a-input placeholder="请输入0-临时 1-永久" v-model="queryParam.isForever"></a-input>
                </a-form-item>
                    </a-col>
                    <a-col :md="12" :sm="16">
                    ...
                    <a-col :md="6" :sm="8">
                        <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                            ...
                            <a-button type="primary" icon="reload" style="margin-left: 8px" @click="searchReset">刷新数据</a-button>
