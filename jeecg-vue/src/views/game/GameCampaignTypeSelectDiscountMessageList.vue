<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('节日活动-自选特惠-传闻部分')">导出</a-button>
    ...
    <gameCampaignTypeSelectDiscountMessage-modal ref="modalForm"
                                                 @ok="modalFormOk"></gameCampaignTypeSelectDiscountMessage-modal>
  </a-card>
</template>
