<template>
    <a-card :bordered="false">
        ...
        <open-service-campaign-lottery-detail-score-modal ref="modalForm" @ok="modalFormOk"></open-service-campaign-lottery-detail-score-modal>
    </a-card>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                ...
                importTextUrl: "game/openServiceCampaignLotteryDetailScore/importText"
            },
            dictOptions: {}
        };
    },
    ...
    methods: {
        ...
        handleAdd() {
            ...
            this.$refs.modalForm.title = "新增积分配置";
        },
        getQueryParams() {
