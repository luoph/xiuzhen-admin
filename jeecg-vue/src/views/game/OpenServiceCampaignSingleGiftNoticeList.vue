<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('开服单笔好礼传闻配置')">导出</a-button>
    ...
    <open-service-campaign-single-gift-notice-modal ref="modalForm"
                                                    @ok="modalFormOk"></open-service-campaign-single-gift-notice-modal>
  </a-card>
</template>
  ...
  data() {
    return {
      ...
      url: {
        ...
        importTextUrl: 'game/openServiceCampaignSingleGiftNotice/importText'
      },
      dictOptions: {}
    };
  },
