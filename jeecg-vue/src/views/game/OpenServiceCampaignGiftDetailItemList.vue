<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('开服礼包道具配置')">导出</a-button>
    ...
    <open-service-campaign-gift-detail-item-modal ref="modalForm"
                                                  @ok="modalFormOk"></open-service-campaign-gift-detail-item-modal>
  </a-card>
</template>
...
export default {
  ...
  data() {
    return {
      description: '开服活动-开服礼包-礼包明细管理页面',
      model: {},
      importText: '',
      // 表头
      columns: [
      ...
      url: {
        ...
        importTextUrl: 'game/openServiceCampaignGiftDetailItem/importText'
      },
      dictOptions: {}
    };
  },
