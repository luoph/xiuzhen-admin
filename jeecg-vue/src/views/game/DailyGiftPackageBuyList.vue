...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: 'game/dailyGiftPackageBuy/list'
      },
      dictOptions: {}
    };
  },
  ...
  methods: {
    ...
    onDateChange: function (value, dateStr) {
      this.queryParam.createTimeBegin = dateStr[0];
      this.queryParam.createTimeEnd = dateStr[1];
    },
    searchQuery() {
      let param = {
        channelId: this.queryParam.channelId,
        serverId: this.queryParam.serverId,
        createTimeBegin: this.queryParam.createTimeBegin,
