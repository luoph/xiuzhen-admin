<template>
    <a-card :bordered="false">
        ...
        <open-service-campaign-rank-detail-message-modal ref="modalForm" @ok="modalFormOk"></open-service-campaign-rank-detail-message-modal>
    </a-card>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                list: "game/openServiceCampaignRankDetailMessage/list",
                delete: "game/openServiceCampaignRankDetailMessage/delete",
                deleteBatch: "game/openServiceCampaignRankDetailMessage/deleteBatch",
                ...
                importTextUrl: "game/openServiceCampaignRankDetailMessage/importText"
            },
            dictOptions: {}
        };
    },
