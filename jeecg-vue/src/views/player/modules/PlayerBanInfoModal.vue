    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="玩家id标识禁用" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['playerIdBan', validatorRules.playerIdBan]" placeholder="请输入玩家id"
                          style="width: 100%"/>
        </a-form-item>
        <a-form-item label="设备标识禁用" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['identifierBan', validatorRules.identifierBan]"
                   placeholder="请输入设备唯一标识禁用:IMEI或者MAC"></a-input>
        </a-form-item>
        <a-form-item label="封号类型:1-临时,2-永久" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['type', validatorRules.type]"
                          placeholder="请输入封号类型(数字):1-临时封号, 2-永久封号" style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="开始时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择开始时间" :showTime="true" dateFormat="YYYY-MM-DD HH:mm:ss"
                  v-decorator="['startTime', validatorRules.startTime]" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="结束时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择结束时间" :showTime="true" dateFormat="YYYY-MM-DD HH:mm:ss"
