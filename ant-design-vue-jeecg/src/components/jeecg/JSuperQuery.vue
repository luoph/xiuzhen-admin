            ...
            <a-row>
                            ...
                            <a-col :span="8">
                                <template v-if="item.dictCode">
                                    <template v-if="item.type === 'table-dict'">
                                        <j-popup v-model="item.val" :code="item.dictTable" :field="item.dictCode" :orgFields="item.dictCode" :destFields="item.dictCode"></j-popup>
                                    </template>
                ...
                <a-col :sm="24" :md="5">
                    ...
                    <a-card class="j-super-query-history-card" :bordered="true">
                        ...
                        <a-tree v-else class="j-super-query-history-tree" showIcon :treeData="treeData" @select="handleTreeSelect" @rightClick="handleTreeRightClick"> </a-tree>
                    </a-card>
                </a-col>
            </a-row>
        </a-spin>
...
export default {
    ...
    methods: {
        ...
        saveToLocalStore() {
            this.$ls.set(
                this.saveCodeBefore + this.saveCode,
