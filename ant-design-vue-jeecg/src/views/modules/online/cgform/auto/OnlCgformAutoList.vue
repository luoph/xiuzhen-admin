<template>
    <a-card :bordered="false" style="height: 100%">
        ...
        <div class="table-operator">
            ...
            <a-button v-if="buttonSwitch.batch_delete" @click="handleDelBatch" style="margin-left:8px" v-show="table.selectedRowKeys.length > 0" ghost type="primary" icon="delete"
                >批量删除</a-button
            >
        </div>
        ...
        <div>
            ...
            >
                ...
                <template slot="fileSlot" slot-scope="text">
                    ...
                    <a-button v-else :ghost="true" type="primary" icon="download" size="small" @click="downloadRowFile(text)">
                        下载
                    </a-button>
                </template>
...
export default {
    ...
    methods: {
        ...
        handleExportXls2() {
            ...
            let url = window._CONFIG["domainURL"] + this.url.exportXls + this.code + "?paramsStr=" + paramsStr;
