    ...
    <a-modal :title="title" :width="800" :visible="visible" :confirmLoading="confirmLoading" @ok="handleOk" @cancel="handleCancel" cancelText="关闭">
        <a-spin :spinning="confirmLoading">
            <a-form :form="form">
                ...
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="代理人用户名">
                ...
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="代理开始时间">
                    <j-date
                ...
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="代理结束时间">
                    <j-date
