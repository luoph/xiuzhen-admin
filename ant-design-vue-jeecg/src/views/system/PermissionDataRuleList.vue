<template>
    <a-drawer title="数据权限规则" :width="drawerWidth" @close="onClose" :visible="visible" :wrapStyle="{ height: 'calc(100% - 108px)', overflow: 'auto', paddingBottom: '108px' }">
        <!-- 抽屉内容的border -->
        <div
            :style="{
                padding: '10px',
        ...
        >
            <div class="table-page-search-wrapper">
                ...
                <a-table ref="table" rowKey="id" size="middle" :columns="columns" :dataSource="dataSource" :loading="loading" :rowClassName="getRowClassname">
