<template>
    <a-modal title="corn表达式" :width="modalWidth" :visible="visible" :confirmLoading="confirmLoading" @ok="change" @cancel="close" cancelText="关闭">
...
export default {
    ...
    computed: {
        ...
        cron() {
            return {
                value: this.result,
                label: `${this.secondsText || "*"} ${this.minutesText || "*"} ${this.hoursText || "*"} ${this.daysText || "*"} ${this.monthsText || "*"} ${this.weeksText ||
                    "*"} ${this.yearsText || "*"}`,
            };
        },
    },
