            ...
            <a-form layout="inline" :form="form">
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="多选组合">
                            <j-checkbox v-model="jcheckbox.values" :options="jcheckbox.options" />
                        </a-form-item>
                    </a-col>
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="代码输入框" style="min-height: 120px">
                            <j-code-editor language="javascript" v-model="jcodedditor.value" :fullScreen="true" style="min-height: 100px" />
                        </a-form-item>
                    </a-col>
                ...
                <a-row :gutter="24">
                    <a-col>
                        ...
                        <a-modal :visible="modal.visible" :width="modal.width" :style="modal.style" @ok="() => (modal.visible = false)" @cancel="() => (modal.visible = false)">
                            <template slot="title">
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="下拉树选择">
                            <j-tree-select v-model="formData.treeSelect" placeholder="请选择菜单" dict="sys_permission,name,id" pidField="parent_id" pidValue="" />
                        </a-form-item>
                    </a-col>
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="下拉树多选">
                            <j-tree-select v-model="formData.treeSelectMultiple" placeholder="请选择菜单" dict="sys_permission,name,id" pidField="parent_id" pidValue="" multiple />
                        </a-form-item>
                    </a-col>
