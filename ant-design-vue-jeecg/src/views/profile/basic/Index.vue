<template>
    <page-layout :title="title">
        <a-card :bordered="false">
            ...
            <s-table style="margin-bottom: 24px" :columns="goodsColumns" :data="loadGoodsData"> </s-table>

            <div class="title">退货进度</div>
            <s-table style="margin-bottom: 24px" :columns="scheduleColumns" :data="loadScheduleData">
