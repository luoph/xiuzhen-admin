...
import cn.youai.xiuzhen.stat.entity.PayOrderGiftVO;
import cn.youai.xiuzhen.stat.mapper.PayOrderGiftVOMapper;
import cn.youai.xiuzhen.stat.service.IPayOrderGiftVOService;
...
public class PayOrderGiftVOServiceImpl implements IPayOrderGiftVOService {
    ...
    public List<PayOrderGiftVO> queryGiftByDateRange(String payTimeBegin, String payTimeEnd, Integer serverId, String channel) {
        ...
        for (PayOrderGiftVO payOrderGiftVO : payOrderGiftVOList) {
            ...
            payOrderGiftVO.setProductCountRatio(BigDecimalUtils.dividePercent(productCountRatio.doubleValue()));

            BigDecimal payAmountRatio = payOrderGiftVO.getPayAmountRatio();
            payOrderGiftVO.setPayAmountRatio(BigDecimalUtils.dividePercent(payAmountRatio.doubleValue()));
        }
