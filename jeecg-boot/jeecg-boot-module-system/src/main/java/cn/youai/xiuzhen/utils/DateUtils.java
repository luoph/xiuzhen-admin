...
public final class DateUtils {
    ...
    /**
     * 计算日期相差月份 end - start， 如果 end < start，返回负数
     * <p>
     * 不足一个月，按一个月算
     *
     * @param start 开始时间
    ...
    public static int monthsBetween(Date start, Date end) {
        return Months.monthsBetween(new DateTime(startTimeOfMonth(start)), new DateTime(startTimeOfMonth(end))).getMonths();
    }

    /**
     * 计算日期相差年度 end - start， 如果 end < start，返回负数
     * <p>
     * 不足一年，按一年算
     *
     * @param start 开始时间
    ...
    public static int yearsBetween(Date start, Date end) {
        return Years.yearsBetween(new DateTime(startTimeOfYear(start)), new DateTime(startTimeOfYear(end))).getYears();
    }
     ...
     * @return 0点时间
     */
    public static Date startTimeOfDate(DateTime date) {
        return date.withTimeAtStartOfDay().toDate();
    }

    public static Date startTimeOfDate(Date date) {
        return startTimeOfDate(new DateTime(date));
    }
     ...
     * @return 结束时间
     */
    public static Date endTimeOfDate(DateTime date) {
        return date.millisOfDay().withMaximumValue().toDate();
    }

    public static Date endTimeOfDate(Date date) {
        return endTimeOfDate(new DateTime(date));
    }
     ...
     * @return xx月1日的时间
     */
    public static Date startTimeOfMonth(DateTime date) {
        return startTimeOfDate(date.dayOfMonth().withMinimumValue());
    }

    public static Date startTimeOfMonth(Date date) {
        return startTimeOfMonth(new DateTime(date));
    }
     ...
     *
     * @param date 日期
     * @return xx月28、29、30、31日的时间
     */
    public static Date endTimeOfMonth(DateTime date) {
        return endTimeOfDate(date.dayOfMonth().withMaximumValue());
    }

    public static Date endTimeOfMonth(Date date) {
        return endTimeOfMonth(new DateTime(date));
    }
     ...
     * @return 1月1日的时间
     */
    public static Date startTimeOfYear(DateTime date) {
        return startTimeOfMonth(date.dayOfYear().withMinimumValue());
    }

    public static Date startTimeOfYear(Date date) {
        return startTimeOfYear(new DateTime(date));
    }
     ...
     * @return 12月31日的时间
     */
    public static Date endTimeOfYear(DateTime date) {
        return endTimeOfMonth(date.dayOfYear().withMaximumValue());
    }

    public static Date endTimeOfYear(Date date) {
        return endTimeOfYear(new DateTime(date));
    }
    ...
    public static Date addMonths(Date date, int days) {
        return new DateTime(date).plusMonths(days).toDate();
    }
     ...
     * @return
     */
    public static Date minusMonths(Date date, int days) {
        return new DateTime(date).minusMonths(days).toDate();
    }
    ...
    public static Date addYears(Date date, int days) {
        return new DateTime(date).plusYears(days).toDate();
    }
     ...
     * @return
     */
    public static Date minusYears(Date date, int days) {
        return new DateTime(date).minusYears(days).toDate();
    }
     ...
     * 月份的开始和结束
     */
    public static Date[] todayMonthStartAndEnd() {
        return monthStartAndEnd(now());
    }
     ...
     * @return
     */
    public static Date[] monthStartAndEnd(Date date) {
        Date[] dates = new Date[2];
        dates[0] = DateUtils.startTimeOfMonth(date);
        dates[1] = DateUtils.endTimeOfMonth(date);
        return dates;
    }
     ...
     * @return 1月1日，12月31日
     */
    public static Date[] yearStartAndEnd(Date date) {
        Date[] dates = new Date[2];
        dates[0] = DateUtils.startTimeOfYear(date);
        dates[1] = DateUtils.endTimeOfYear(date);
        return dates;
    }
    ...
    /**
     * 如果startDate和endDate是同一天,则换成当天的0点与23:59:59点,否则不变
     *
     * @param startDate
     * @param endDate
     */
    public static Date[] queryDateOfSameDay(Date startDate, Date endDate) {
        ...
        if (isSameDay(startDate, endDate)) {
            result = dateStartAndEnd(startDate);
        } else {
            result[0] = startDate;
            result[1] = endDate;
        }
