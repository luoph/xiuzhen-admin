...
import cn.youai.xiuzhen.game.constant.FairyJadeBuyType;
...
import cn.youai.xiuzhen.game.service.IRechargeOrderService;
...
public class RechargeOrderController extends JeecgController<RechargeOrder, IRechargeOrderService> {
    ...
    public Result<?> preferenceGiftList(@RequestParam(name = "rangeDateBegin", defaultValue = "") String rangeDateBegin,
        ...
        String channel = gameChannelService.queryChannelNameById(channelId);
        List<GameChalcedonyOrder> gameChalcedonyOrders = service.queryExpendGiftList(rangeDateBegin, rangeDateEnd, days, serverId, channel, FairyJadeBuyType.DAILY_GIFT.getType().toString());
    ...
    public Result<?> atListGiftList(@RequestParam(name = "rangeDateBegin", defaultValue = "") String rangeDateBegin,
        ...
        String channel = gameChannelService.queryChannelNameById(channelId);
        List<GameChalcedonyOrder> gameChalcedonyOrders = service.queryExpendGiftList(rangeDateBegin, rangeDateEnd, days, serverId, channel, FairyJadeBuyType.OPEN_SERVICE_GIFT.getType().toString());
        page.setRecords(gameChalcedonyOrders).setTotal(gameChalcedonyOrders.size());
        return Result.ok(page);
    }
    ...
    public Result<?> zeroBuyGiftList(@RequestParam(name = "rangeDateBegin", defaultValue = "") String rangeDateBegin,
        ...
        String channel = gameChannelService.queryChannelNameById(channelId);
        List<GameChalcedonyOrder> gameChalcedonyOrders = service.queryExpendGiftList(rangeDateBegin, rangeDateEnd, days, serverId, channel, FairyJadeBuyType.ZERO_BUY.getType().toString());
        page.setRecords(gameChalcedonyOrders).setTotal(gameChalcedonyOrders.size());
        return Result.ok(page);
    }
