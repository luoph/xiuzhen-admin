...
public class OpenServiceCampaignSingleGiftItemController extends JeecgController<OpenServiceCampaignSingleGiftItem, IOpenServiceCampaignSingleGiftItemService> {
    ...
    @AutoLog(value = "开服活动-单笔好礼-任务明细-列表查询")
