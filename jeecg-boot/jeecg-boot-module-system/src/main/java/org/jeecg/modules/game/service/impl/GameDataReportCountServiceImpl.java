...
public class GameDataReportCountServiceImpl extends ServiceImpl<GameDataReportCountMapper, GameDataReportCount> implements IGameDataReportCountService {
    ...
    private List<GameDataReportCount> getCompleteList(List<GameDataReportCount> list) {
        ...
        for (GameDataReportCount gameDataReportCount : list) {
            ...
            BigDecimal oldArpu = BigDecimalUtil.divideTwo(gameDataReportCount.getOldArpu().doubleValue());
            gameDataReportCount.setOldArpu(oldArpu);

            BigDecimal oldArppu = BigDecimalUtil.divideTwo(gameDataReportCount.getOldArppu().doubleValue());
        ...
        // ARPU汇总
        arpuSum = BigDecimalUtil.divideZero(payAmountSum, loginNumSum, false);
        ...
        // 新增ARPU汇总
        addArpuSum = BigDecimalUtil.divideZero(addPayAmountSum, addNumSum, false);
        ...
        child.setOldPayAmount(BigDecimalUtil.divideTwo(oldPayAmountSumBigDecimal.doubleValue()));
        //child.setOldArpu(oldArpuSum);
        child.setOldArpu(BigDecimalUtil.divideTwo(oldArpuSum.doubleValue()));
        //child.setOldArppu(oldArppuSum);
        child.setOldArppu(BigDecimalUtil.divideTwo(oldArppuSum.doubleValue()));
        child.setDateStr("汇总");
