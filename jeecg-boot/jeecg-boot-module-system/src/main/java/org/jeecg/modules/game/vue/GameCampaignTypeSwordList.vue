<template>
    <a-card :bordered="false">
        ...
        <gameCampaignTypeSword-modal ref="modalForm" @ok="modalFormOk"></gameCampaignTypeSword-modal>
    </a-card>
</template>
...
export default {
    name: "GameCampaignTypeSwordList",
    mixins: [JeecgListMixin],
    components: {
        GameCampaignTypeSwordModal
    },
    data() {
        return {
            description: "game_campaign_type_sword管理页面",
            // 表头
            columns: [
                {
                    title: "#",
            ...
            url: {
                list: "game/gameCampaignTypeSword/list",
