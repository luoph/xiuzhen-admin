...
public class OpenServiceCampaignRankDetailRankingController extends JeecgController<OpenServiceCampaignRankDetailRanking, IOpenServiceCampaignRankDetailRankingService> {
    ...
    @Autowired
    private IOpenServiceCampaignRankDetailRankingService gameOpenServiceCampaignRankDetailRankingService;
    ...
    public Result<?> queryPageList(OpenServiceCampaignRankDetailRanking openServiceCampaignRankDetailRanking,
        ...
        IPage<OpenServiceCampaignRankDetailRanking> pageList = gameOpenServiceCampaignRankDetailRankingService.page(page, queryWrapper);
    ...
    public Result<?> add(@RequestBody OpenServiceCampaignRankDetailRanking openServiceCampaignRankDetailRanking) {
        gameOpenServiceCampaignRankDetailRankingService.save(openServiceCampaignRankDetailRanking);
    ...
    public Result<?> edit(@RequestBody OpenServiceCampaignRankDetailRanking openServiceCampaignRankDetailRanking) {
        gameOpenServiceCampaignRankDetailRankingService.updateById(openServiceCampaignRankDetailRanking);
    ...
    public Result<?> delete(@RequestParam(name = "id") String id) {
        gameOpenServiceCampaignRankDetailRankingService.removeById(id);
    ...
    public Result<?> deleteBatch(@RequestParam(name = "ids") String ids) {
        this.gameOpenServiceCampaignRankDetailRankingService.removeByIds(Arrays.asList(ids.split(",")));
    ...
    public Result<?> queryById(@RequestParam(name = "id") String id) {
        OpenServiceCampaignRankDetailRanking openServiceCampaignRankDetailRanking = gameOpenServiceCampaignRankDetailRankingService.getById(id);
