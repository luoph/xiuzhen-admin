...
public class SysDepartController extends JeecgController<SysDepart, ISysDepartService> {
...
//		}
    ...
    @Override
    protected void onload(List<SysDepart> pageList) {
    ...
    public ModelAndView exportXls(SysDepart sysDepart, HttpServletRequest request) {
        return super.exportXls(request, sysDepart, SysDepart.class, "部门列表");
    }
