...
public class SysCategoryController extends JeecgController<SysCategory, ISysCategoryService> {
    ...
    public ModelAndView exportXls(HttpServletRequest request, SysCategory sysCategory) {
        return super.exportXls(request, sysCategory, SysCategory.class, "分类字典");
    }
