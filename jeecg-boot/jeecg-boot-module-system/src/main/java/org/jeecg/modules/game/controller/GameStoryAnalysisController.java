...
public class GameStoryAnalysisController {
    ...
    public Result<?> queryPageList(GameStoryAnalysis gameStoryAnalysis,
                                   @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
                                   @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
                                   HttpServletRequest req) {
        // QueryWrapper<GameStoryAnalysis> queryWrapper = QueryGenerator.initQueryWrapper(gameStoryAnalysis, req.getParameterMap());
        Page<GameStoryAnalysis> page = new Page<>(pageNo, pageSize);
        // IPage<GameStoryAnalysis> pageList = gameStoryAnalysisService.page(page, queryWrapper);
        return Result.ok();
    }
