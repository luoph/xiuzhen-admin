...
public class PlayerInfoController extends MultiDataSourceController<PlayerInfo, IPlayerInfoService> {

    @Override
    @AutoLog(value = "玩家信息-列表查询")
    @GetMapping(value = "/list")
    public Result<?> queryPageList(PlayerInfo model,
    ...
    public Result<?> add(@RequestBody PlayerInfo model, @RequestParam(name = "serverId", required = false) Integer serverId) {
    ...
    public Result<?> edit(@RequestBody PlayerInfo model, @RequestParam(name = "serverId", required = false) Integer serverId) {
    ...
    protected ModelAndView exportXls(@RequestParam(name = "serverId", required = false) Integer serverId,
                                     HttpServletRequest request, PlayerInfo object, Class<PlayerInfo> clazz, String title) {
    ...
    protected Result<?> importExcel(@RequestParam(name = "serverId", required = false) Integer serverId,
                                    HttpServletRequest request, HttpServletResponse response, Class<PlayerInfo> clazz) {
